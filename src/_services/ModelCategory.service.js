...
function FindbyModelCategoryId(_id) {
    ...
    return fetch(`${API_URL}/ModelCategory/FindbyId/${_id}`, requestOptions).then(handleResponse);
}
function FindAll() {
    const auth = header;
    const headers = new Headers();
...
function Delete(_id) {
    ...
    return fetch(`${API_URL}/ModelCategory/delete/${_id}`, requestOptions).then(handleResponse);
}

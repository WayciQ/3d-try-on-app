...
function FindByModelId(_id) {
  ...
  return fetch(`${API_URL}/Model/FindById/${_id}`, requestOptions).then(
    handleResponse
  );
}
function FindByModelCategory(id) {
  ...
  return fetch(
    `${API_URL}/Model/FindByModelCategory/${id}`,
    requestOptions
  ).then(handleResponse);
}
...
function Delete(_id) {
  ...
  return fetch(`${API_URL}/Model/delete/${_id}`, requestOptions).then(
    handleResponse
  );
}
...
function uploadFile(file) {
  ...
  console.log(file);
  return fetch(`${API_URL}/Model/uploadFile`, requestOptions).then(
    handleResponse
  );
}
